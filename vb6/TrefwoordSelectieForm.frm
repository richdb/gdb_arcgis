VERSION 5.00
Begin VB.Form TrefwoordSelectieForm 
   Caption         =   "Form2"
   ClientHeight    =   3122
   ClientLeft      =   56
   ClientTop       =   336
   ...
   Begin VB.ListBox List2 
      Height          =   1876
      ItemData        =   "TrefwoordSelectieForm.frx":0000
      Left            =   3906
      List            =   "TrefwoordSelectieForm.frx":0002
      TabIndex        =   3
      Top             =   378
      Width           =   2156
   End
   Begin VB.ListBox List1 
      Height          =   1876
      ItemData        =   "TrefwoordSelectieForm.frx":0004
      Left            =   252
      List            =   "TrefwoordSelectieForm.frx":0006
      TabIndex        =   2
      Top             =   378
      Width           =   2156
   End
   ...
   End
End
Attribute VB_Name = "TrefwoordSelectieForm"
...
With rs
    If .RecordCount > 1 Then
        .MoveFirst
        Do
            List1.AddItem .Fields("TREFWOORD")
            .MoveNext
        Loop Until .EOF
    End If
    .Close
...
Unload TrefwoordSelectieForm
End Sub
Private Sub Form_Load()
TrefwoordSelectieForm.Caption = Form1.versie + " - Trefwoord Selectie"
...
SelectieForm.TrefwoordTextbox.Text = selectie
Unload TrefwoordSelectieForm
Exit Sub
ErrorHandler:
  MsgBox "Er is een fout opgetreden in de ArcGIS - GBI tool." & vbCr & vbCr & _
